...
<?php if (isSearchBot()){ ?>
    <div style="padding:0 15px 10px 15px;">
        <a style="color:#aaa" href="http://inviter.biz/articles/nakrutka_podpischikov_v_gruppu_vkontakte">Накрутка подписчиков в группу вконтакте</a>
    </div>


    <div style="padding:0 15px 10px 15px;">
        <a style="color:#aaa" href="http://inviter.biz/articles/nakrutka_podpischikov_v_gruppu_vk">Накрутка подписчиков в группу вк</a>
    </div>
<?php } ?>
