/*
 * File application/express/settings/language/En.js
 * const En = require('application/express/settings/language/En');
 *
 */
...
module.exports = {
    ...
    ['form/map_new_point/category/' + Constants.NONE_CATEGORY_CODE]: 'Select from the list',
