...
$settings_site = 'gmail.com';
$settings_limit = 90;
$my_email_for_revision = 'ladonin85@gmail.com'; //куда шлем, чтобы проверить что он отсылается


// чтобы была хаотичность в периоде отправки - иногда много шлем, иногда не шлем вообще
if (rand(1, 2) == 1) {
    exit();
}
